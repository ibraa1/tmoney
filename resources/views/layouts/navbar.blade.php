<header class="app-header app-header-dark">
    ...
    <div class="top-bar d-flex align-items-center justify-content-between">
        ...
        <div class="top-bar-brand">
            ...
            <a href="{{ route('home') }}">
                <img style="height: 100px; width: 100px" src="{{ asset('assets/images/logo.png') }}" alt="Logo">
            </a>
        </div><!-- /.top-bar-brand -->
        <!-- .top-bar-list -->
        <div class="top-bar-list">
            ...
            @if (Auth::user()->role == 'agent')
                <div class="top-bar-item top-bar-item-center d-none d-md-flex">
                    <!-- Modified class added here -->
                    <span class="balance">
            ...
            <div class="top-bar-item top-bar-item-right px-0 d-none d-sm-flex">
                ...
                <div class="dropdown d-none d-md-flex">
                    <button class="btn-account" type="button" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false">
                        <span class="user-avatar user-avatar-md"><img src="{{ asset(Auth::user()->image) }}"
                                alt=""></span>
                        <span class="account-summary pr-lg-4 d-none d-lg-block">
                            <span class="account-name">{{ Auth::user()->prenom }}</span>
                            <span class="account-description">{{ ucfirst(Auth::user()->role) }}</span>
                        </span>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('profile.edit', Auth::user()->id) }}">
                            <span class="dropdown-icon oi oi-person"></span> Mon profil
                        </a>
