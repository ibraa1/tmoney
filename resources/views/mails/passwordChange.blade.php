    ...
    <table style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <tr>
            <td style="background-color: #ffffff; padding: 40px;">
                ...
                <p>Nous vous recommandons de changer votre mot de passe dès votre première connexion. Vous pouvez le
                    faire en accédant à votre profil et en sélectionnant l'option "Changer le mot de passe".</p>
                <p>Voici le lien pour se connecter : <strong><a href="tmoney.pro/login">tmoney.pro/login</a></strong></p>
