...
@section('title', 'Ajouter une balance | TMoney')
@section('content')
    ...
    <header class="page-title-bar">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">
                    <a href="{{ route('users.index') }}"><i class="breadcrumb-icon fa fa-angle-left mr-2"></i>users</a>
                </li>
            </ol>
        </nav><!-- /.breadcrumb -->
        <!-- floating action -->
        ...
        <div class="d-md-flex align-items-md-start">
            <h1 class="page-title mr-sm-auto"> Ajouter une balance </h1><!-- .btn-toolbar -->
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-fluid">
                    ...
                    <div class="card-body">
                        <!-- form -->
                        <form method="POST" action="{{ route('balances.add') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row">
                                <!-- form column -->
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="input02">Montant total de la commission <abbr
                                        ...
                                        class="form-control" readonly required id="input02" value="0"
                                        name="montantTotalComission">
                                    @error('montantTotalComission')
                                        <div class="">
                            ...
                            <div class="form-row">
                                ...
                                <input type="hidden" name="userId" value="{{ $user->id }}"><!-- /form column -->
                            </div><!-- /form row -->
